namespace Robots.Tests
{
    ...
    public class RobotsTests
    {
        ...
        [Test]
        public void ConstructorShouldThrowAnException()
        {
        ...
        [Test]
        public void AddShouldThrowExceptionSameName()
        {
            var robots = new RobotManager(100);
            robots.Add(new Robot("r1", 100));
        ...
        [Test]
        public void AddShouldThrowExceptionReachedCapacity()
        {
        ...
        [Test]
        public void RemoveShouldThrowExceptionNoRobot()
        {
            var robots = new RobotManager(2);
            robots.Add(new Robot("r1", 100));
            Assert.Throws<InvalidOperationException>(() =>
        ...
        [Test]
        public void WorkShouldThrowAnException()
        {
            var robots = new RobotManager(2);
            var robot = new Robot("r1", 100);
            robots.Add(robot);
        ...
        [Test]
        public void WorkShouldThrowAnExceptionRobotIsExhousted()
        {
            var robots = new RobotManager(2);
            var robot = new Robot("r1", 20);
            robots.Add(robot);
            Assert.Throws<InvalidOperationException>(()
                => robots.Work("r1", "...", 30));
        }
        ...
        [Test]
        public void ChargeShouldThrowAnExceptionRobotIsNotFound()
        {
            var robots = new RobotManager(2);
            var robot = new Robot("r1", 100);
            robots.Add(robot);
